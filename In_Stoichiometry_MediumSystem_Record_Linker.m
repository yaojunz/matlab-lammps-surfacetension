...
for Linker=2
    for record=2:4
        ...
        mkdir(InFolder);
        OutFolder=['Out_Record' num2str(record) '/'];
...
%                         '_N1_' num2str(np1) '_N2_' num2str(np2) '.mat']);
        ...
        for rep=(1:Replicates)
            ...
            InitCondFilename=['Out_Record' num2str(record-1) '/L1_' num2str(L1) '_L2_' num2str(L2) '_N1_' num2str(np1) '_N2_' num2str(np2) '_A' num2str(A) '_Rep' num2str(rep) '.restart'];
%             if rep==1
